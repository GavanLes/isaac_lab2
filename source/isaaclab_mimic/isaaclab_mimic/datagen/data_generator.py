...
class DataGenerator:
    ...
    def generate_eef_subtask_trajectory(
        ...
        if subtask_object_name is not None:
            print(f"[DEBUG] subtask={subtask_ind} obj={subtask_object_name}")
            print(f"[DEBUG]   current obj pose z: {subtask_object_pose[2,3]:.4f}")
            print(f"[DEBUG]   src obj pose z:     {src_subtask_object_pose[2,3]:.4f}")
            print(f"[DEBUG]   src_eef first z:    {src_eef_poses[0,2,3]:.4f}")
            print(f"[DEBUG]   src_eef last z:     {src_eef_poses[-1,2,3]:.4f}")
            print(f"[DEBUG]   transformed first z: {transformed_eef_poses[0,2,3]:.4f}")
            print(f"[DEBUG]   transformed last z:  {transformed_eef_poses[-1,2,3]:.4f}")
