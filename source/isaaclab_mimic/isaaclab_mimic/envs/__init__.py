...
##
# OpenArmX Cube-to-Tray: IK Relative Pose Control
##
gym.register(
    id="Isaac-OpenArm-Cube-Tray-IK-Rel-Mimic-v0",
    entry_point=f"{__name__}.openarm_cube_tray_mimic_env:OpenArmCubeTrayMimicEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.openarm_cube_tray_mimic_env_cfg:OpenArmCubeTrayMimicEnvCfg",
    },
    disable_env_checker=True,
)
